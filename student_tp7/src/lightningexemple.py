...
"""
Aller dans anaconda prompt : 
    taper : conda activate deepdac
    et ensuite : pip install pytorch-lightning
"""
...
"""
A revoir car : 
    j'obtient cet erreur : ValueError: 
     you tried to log 0.8424999713897705 which is currently not supported. Try a dict or a scalar/tensor.
